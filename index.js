...
const {obterAlunos} = require('./db/alunosModel');
const conexaodb = require ("./db/db")
...
app.post('/login', (req, res) => {
    if (req.body.user === 'Natanael' && req.body.pass === '123456') {
        const id = 1;
...
/* F. Rota DELETE excluir um aluno */
